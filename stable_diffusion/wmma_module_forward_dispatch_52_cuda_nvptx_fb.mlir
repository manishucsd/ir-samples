    ...
    hal.executable.variant public @cuda_nvptx_fb, target = <"cuda", "cuda-nvptx-fb", {target_arch = "sm_80"}> {
      ...
      builtin.module {
        func.func @forward_dispatch_52_batch_matmul_10x4096x64x4096() {
          ...
          %13 = linalg.batch_matmul {compilation_info = #iree_codegen.compilation_info<lowering_config = <tile_sizes = [[1, 128, 64, 128]]>, translation_info = <LLVMGPUMatmulTensorCore pipeline_depth = 2>, workgroup_size = [64, 2, 1]>} ins(%9, %10 : tensor<10x4096x4096xf16>, tensor<10x4096x64xf16>) outs(%12 : tensor<10x4096x64xf16>) -> tensor<10x4096x64xf16> loc("<stdin>":1678:12)
